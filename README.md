...
* **Perfect Inelastic Collisions:** When two celestial bodies collide, they merge into a single body conserving total momentum ($m_1 \vec{v}_1 + m_2 \vec{v}_2 = m_{total} \vec{v}_{new}$) and dynamically recalculating the new radius based on combined volume.
