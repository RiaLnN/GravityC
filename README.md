...
* **Perfect Inelastic Collisions:** When two celestial bodies collide, they merge into a single body conserving total momentum $m_{1} \vec{v}_{1} + m_{2} \vec{v}_{2} = m_{total} \vec{v}_{new}$ and dynamically recalculating the new radius based on combined volume.
